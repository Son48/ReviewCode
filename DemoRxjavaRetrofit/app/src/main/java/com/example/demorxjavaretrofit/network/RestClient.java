package com.example.demorxjavaretrofit.network;
...
public class RestClient {
    ...
    private static Retrofit.Builder builder =
            new Retrofit.Builder()
                    .baseUrl(BASE_URL)
                    //để làm retrofit làm việc với RXjava cần phải thêm RxJava2CallAdapterFactory.create()
                    .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                    //phân tích json trả về từ server thong qua gson
